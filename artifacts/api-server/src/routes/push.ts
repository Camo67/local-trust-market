...
router.use(authMiddleware);
  ...
  /**
   * SECURITY: Generic error messages are used to prevent internal implementation details
   * from leaking in production responses. Errors are logged server-side for debugging.
   */
